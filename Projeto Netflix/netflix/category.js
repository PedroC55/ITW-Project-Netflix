...
var vm = function () {
    ...
    };
    {
        $("#searchbtn").click((event) => {
            ...
            var urlBaseSearch = "http://192.168.160.58/netflix/api/Search/Categories";
            ...
            if (InputSearch.length > 0) {
                ...
                ajaxHelper(SearchURIfml, 'GET').done(function (data) {
                    if (data.length > 0) {
                        ...
                        alert("Não existe nenhuma categoria!")
                        $('#sair').addClass('d-none');
        ...
        $("#searchfilm").autocomplete({
            source: function (request, response) {
                $.ajax({
                    ...
                    url: "http://192.168.160.58/netflix/api/Search/Categories?name=" + $('#searchfilm').val(),
                    dataType: "json",
                    data: {
                        term: request.term
                    },
